...
add_action('wp_ajax_bpl_resource_filter', 'bpl_resource_vault_ajax_filter');
add_action('wp_ajax_nopriv_bpl_resource_filter', 'bpl_resource_vault_ajax_filter');
function bpl_resource_vault_ajax_filter() {
